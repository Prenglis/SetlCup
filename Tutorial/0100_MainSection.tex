...
The scanner is responsible for checking whether the input file consists of the defined tokens. It can be written by assigning the Regex to the Tokenname \mRefFigure{fig:scanner_def}.
\begin{figure}[!ht]
\begin{Verbatim}[ frame         = lines, 
                  framesep      = 0.3cm, 
                  labelposition = bottomline,
...
\section{Parser-Part}
In this part the grammar-rules are defined with the a syntax which has many analogies to JavaCup and ANTLR \mRefFigure{fig:example_grammer}.
\begin{figure}[!ht]
\begin{Verbatim}[ frame         = lines, 
                  framesep      = 0.3cm, 
                  labelposition = bottomline,
