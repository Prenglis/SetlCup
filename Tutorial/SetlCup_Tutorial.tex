...
\newcommand{\mRefFigure}[1]{(see Figure \ref{#1}, Page \pageref{#1})}
\newcommand{\mRefTable}[1]{(see Table \ref{#1}, Page \pageref{#1})}
\newcommand{\mRefEqu}[1]{(see Equation \ref{#1}, Page \pageref{#1})}
